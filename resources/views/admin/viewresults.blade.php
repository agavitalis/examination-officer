@extends('layouts.master')
          ...
          <div class="col col-md-12">
            ...
            <div class="box box-border">
              <div class="box-header with-border text-center">
                <h3 class="box-title">Results uploaded to the portal by the lecturers</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  ...
                  <tbody id="list-lect">
                    ...
                    <tr>
                        ...
                        <td>@if($result->approved == 1)
                          <button data-name="{{$result->name}}" data-username="{{$result->username}}" data-level="{{$result->level}}" data-session="{{$result->session}}" data-semester="{{$result->semester}}" title="This will Unapprove this result, and Lecturer can edit it" class=" reject btn btn-sm btn-danger "><i class="glyphicon glyphicon-remove"></i></button>
                          @else
                          <button  title="Approve result first to disapprove" class=" btn btn-sm btn-danger disabled"><i class="glyphicon glyphicon-ok"></i></button>
                          @endif
                        </td>
                ...
                <div class="error-div">
                 ...
                 <div class="box-body">
                  ...
                  <div class="row">
                    <form role="form" method="POST" action="/admin/viewresults">
                        <!-- text input -->
                        {{ csrf_field() }}
  ...
  @section('myscripts')
     <script src="{{asset('js/myscripts/admin.viewresults.js')}}"></script>
   <!-- Datatables -->
