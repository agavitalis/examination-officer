  				...
  				<div class="modal-body">
  					<form class="form-horizontal" role="form">
  						<div class="form-group">
  							<label class="control-label col-sm-2" for="id">Lecturer name:</label>
  							<div class="col-sm-10">
  								<input type="text" class="form-control" id="l-name" disabled>
  							</div>
  						</div>
  						<div class="form-group">
  							<label class="control-label col-sm-2" for="name">Staff Registration Number:</label>
  							<div class="col-sm-10">
  								<input type="name" class="form-control" id="l-username">
  							</div>
  						</div>
                        <div class="form-group">
  							<label class="control-label col-sm-2" for="name">Email Address:</label>
  							<div class="col-sm-10">
  								<input type="name" class="form-control" id="l-email">
  							</div>
  						</div>
                        <div class="form-group">
