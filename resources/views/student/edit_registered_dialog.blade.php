          ...
          <div class="col col-md-8 col-md-offset-2">
            ...
            <div class="lockscreen-wrapper box box-border">
              <div class="box-header with-border">
                <h3 class="box-title">Select Session and Semester to Edit Registered Courses </h3><br><small>Approved courses cannot be edited</small>
              </div>
              <!-- /.box-header -->
              <div class=" box-body">
                    <form  action="/student_edit_registered" method="post" role="form">
                            <!-- text input -->
                            {{ csrf_field() }}
                            <!-- input states -->
                            ...
                            <div class="form-group input-group-md has-success">
                                ...
                                <span class="input-group-btn ">
                                    <button type="submit"  class="btn btn-success btn-flat pull-right"><i class="fa fa-pencil"></i>Edit Courses!</button>
                                </span>
                            </div>
